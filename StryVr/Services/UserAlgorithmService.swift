    ...
    func trackUserAction(_ action: UserAction) async {
        ...
        case .skillInteraction:
            if let timeSpent = action.timeSpent {
                subscriptionService.trackSkillInteraction(action.skillName ?? "", timeSpent: timeSpent)
            }
    ...
    private func generateRecommendations() async {
        ...
        if let topSkill = insights.topSkills.first {
            recommendations.append(Recommendation(
                ...
                description: "Based on your interest in \(topSkill), here are advanced techniques to excel.",
                priority: .high,
        ...
        if let mostUsedFeature = insights.mostUsedFeature {
            recommendations.append(Recommendation(
                ...
                description: "You're already using this feature frequently. Here's how to get even more value.",
                priority: .medium,
        ...
        if insights.goalsCompleted > 0 {
            recommendations.append(Recommendation(
                ...
                description: "You've completed \(insights.goalsCompleted) goals. Time to challenge yourself further.",
                priority: .high,
    ...
    private func generateCareerPathSuggestions(insights: UserInsights) async {
        ...
        if hasLeadershipSkills {
            suggestions.append(CareerPath(
                ...
                skills: ["Strategic Planning", "Business Development", "Executive Communication"],
...
struct UserAction {
    ...
    init(type: UserActionType, feature: SubscriptionFeature? = nil, goalType: String? = nil, progress: Double? = nil, skillName: String? = nil, timeSpent: TimeInterval? = nil, careerPath: String? = nil, feedback: String? = nil, rating: Int? = nil) {
        self.type = type
