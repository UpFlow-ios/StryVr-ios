...
final class TeamHealthService {
    ...
    static let mockData: [TeamHealthStat] = [
        TeamHealthStat(
            id: "1", employeeName: "Elena Maxwell", productivityScore: 89.5, wellnessScore: 94.0,
            checkInMood: "😊", lastActiveDate: Date(), week: "Week 1", overallHealthScore: 91.75,
            categories: [
        ...
        TeamHealthStat(
            ...
            checkInMood: "😞",
            lastActiveDate: Calendar.current.date(byAdding: .day, value: -2, to: Date())!,
            week: "Week 1", overallHealthScore: 54.0,
            categories: [
